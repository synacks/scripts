...
# apt-get -y update
# apt-get -y install ppp iptables make gcc gmp-devel libgmp3-dev bison flex libpcap-dev lsof vim xl2tpd
# apt-get install -y build-essential libgmp3-dev bison flex libpcap-dev ppp lsof xl2tpd
#
cur_dir=`pwd`
